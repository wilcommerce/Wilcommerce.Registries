...
{
    public class CustomerAccountRemovedEventTest
    {
        [Fact]
        public void Ctor_Should_Set_All_Values_Correctly()
        {
            ...
            var ev = new CustomerAccountRemovedEvent(customerId, userName);
        ...
        public void ToString_Should_Return_Event_Formatted_As_String()
        {
            ...
            string eventAsString = $"Account {userName} removed from customer {customerId}";
