...
namespace Wilcommerce.Registries.Events.Customer
{
    ...
    /// </summary>
    public class CustomerAccountSetEvent : DomainEvent
    {
        /// <summary>
        /// Get the customer id
        /// </summary>
        ...
        public CustomerAccountSetEvent(Guid customerId, string userName)
        ...
        {
            return $"Account {UserName} set for customer {CustomerId}";
        }
    }
}
